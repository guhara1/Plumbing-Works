...
AREA_BLOCK = """<section class="section section--off" aria-labelledby="area-h">
  <div class="container area-block">
    ...
    <nav class="region-grid" aria-label="시도 바로가기">
      <a href="/area/seoul/">서울</a><a href="/area/busan/">부산</a><a href="/area/">대구</a><a href="/area/">인천</a>
      <a href="/area/">광주</a><a href="/area/">대전</a><a href="/area/">울산</a><a href="/area/">세종</a>
      <a href="/area/gyeonggi/">경기</a><a href="/area/">강원</a><a href="/area/">충북</a><a href="/area/">충남</a>
      <a href="/area/">전북</a><a href="/area/">전남</a><a href="/area/">경북</a><a href="/area/">경남</a><a href="/area/">제주</a>
    </nav>
  </div>
</section>
"""
...
def area_index():
    SIDO = ["서울특별시","부산광역시","대구광역시","인천광역시","광주광역시","대전광역시","울산광역시",
            ...
            "경상북도","경상남도","제주특별자치도"]
    links = {"서울특별시":"/area/seoul/","부산광역시":"/area/busan/","경기도":"/area/gyeonggi/"}
    cards = ""
    for s in SIDO:
        u = links.get(s, "/area/")
