  ...
  <div class="container header-inner">
    ...
    <nav class="gnb" aria-label="주 메뉴" id="gnb">
      ...
      <div class="mobile-only-cta">
        ...
        <a class="btn btn--ghost-light btn--block" href="https://t.me/googleseolab" target="_blank" rel="noopener">무료 견적 신청</a>
      </div>
    </nav>
...
FOOTER = """<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-biz">
      ...
      <div>주소: (미정) · 대표전화: <a href="tel:0000-0000" style="color:#C7D6EC;">0000-0000</a> · 카카오톡: @스피드배관</div>
    </div>
...
MOBILE_BAR = """<nav class="mobile-bar" aria-label="빠른 연락">
  ...
  <a class="is-primary" href="https://t.me/googleseolab" target="_blank" rel="noopener"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="9" y1="15" x2="15" y2="15"/></svg>견적</a>
</nav>
"""
  ...
  <div class="container">
    <div class="cta-banner"><div class="cta-banner-inner">
      ...
      <div class="hero-cta">
        ...
        <a class="btn btn--ghost-light btn--lg" href="https://t.me/googleseolab" target="_blank" rel="noopener">무료 견적 신청</a>
      </div>
    </div></div>
  </div>
</section>
