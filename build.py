...
FOOTER = """<footer class="site-footer">
  <div class="container">
    ...
    <div class="footer-keywords">
      <h4>취급 항목</h4>
      <p>누수탐지 · 누수공사 · 하수구막힘 · 배관막힘 · 배관설비 · 수전교체 · 싱크대수전교체 · 화장실수전교체 · 변기막힘 · 화장실변기교체 · 변기부속품수리 · 싱크대하수구막힘 · 세면대막힘 · 세면대교체 · 배수구막힘 · 배수구뚫음 · 욕실배관누수 · 수도누수 · 수도수리 · 주방배관누수 · 주방배수구막힘 · 이물질 제거 · 배관내시경 · 역류 · 물샘 · 부품 교체 · 고압세척 — 합리적인 비용 · 가격의 24시 긴급출동 배관 업체</p>
    </div>
    ...
    <!-- 광고주 모집 배너(푸터) 비활성화 — 필요 시 아래 블록 주석 해제
...
MOBILE_BAR = """<nav class="mobile-bar" aria-label="빠른 연락">
  ...
  <!-- 광고문의(모바일 하단바) 비활성화 — 필요 시 아래 줄 주석 해제
...
def page(path, title, desc, canonical, body, jsonld="", og_title=None, og_desc=None, noindex=False):
    ...
    # 광고문의 팝업 비활성화(주석처리) — 필요 시 아래에 " + AD_POPUP" 를 다시 추가
  ...
  <div class="container">
    <div class="cta-banner"><div class="cta-banner-inner">
      ...
      <div class="hero-cta">
        ...
        <!-- 광고문의(하단 CTA) 비활성화 — 필요 시 아래 줄 주석 해제
