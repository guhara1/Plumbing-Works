  ...
  <div class="container hero-inner">
    ...
    <div class="hero-media">
      <figure class="hero-photo-frame">
        <img class="hero-photo" src="/assets/img/hero.jpg" alt="스피드 배관공사 현장 작업 이미지"
             width="1280" height="720" loading="eager" onerror="this.style.display='none'">
      </figure>
    </div>
  </div>
</section>
...
"""
    page(f"area/{sido_slug}/{gu_slug}-gu/index.html",
         ...
         f"{sido_ko} {gu_ko} 배관공사, 하수구막힘, 싱크대막힘, 변기막힘, 욕실 배수구 역류, 배관내시경, 고압세척 상담 안내. {gu_ko} 주요 행정동 확인 가능합니다.",
...
"""
        page(f"area/{sido_slug}/{gu_slug}-gu/{slug}-dong/index.html",
             f"{ko} 배관공사·하수구막힘 | 싱크대·변기·배수구 막힘 상담 - 스피드 배관공사",
             f"{gu_ko} {ko} 배관공사, 하수구막힘, 싱크대막힘, 변기막힘, 욕실 배수구 역류, 배관내시경, 고압세척 상담 안내. {ko} 및 인근 지역 확인 가능합니다.",
